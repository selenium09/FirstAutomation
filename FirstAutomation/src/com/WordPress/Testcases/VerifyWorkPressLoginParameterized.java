 ...
 *
 */
public class VerifyWorkPressLoginParameterized 
{
	...
	public void verifyValidLogin() throws InterruptedException
	{
		...
		//login.typeUserName("sumit_GRM");							//calling all the methods, but we usually do with arguments
		//login.typePassword("isaplim");
		//login.clickOnLoginButton();
		
		login.loginTOWordPress("sumit_GRM", "isaplim");		//calling the method from here instead of upper lines
